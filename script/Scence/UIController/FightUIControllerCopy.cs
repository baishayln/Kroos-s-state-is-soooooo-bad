...
public class FightUIControllerCopy : MonoBehaviour
{
    ...
    {
        transform.GetComponent<EnemyBornControllerCopy>().PauseBornEnemy();
        ...
        transform.GetComponent<EnemyBornControllerCopy>().ContinueBornEnemy();
        StartTiming();
    }
    ...
    // {
    //     transform.GetComponent<EnemyBornControllerCopy>().StartBornEnemy();
    // }
    public void GameOver()              //游戏失败时的显示画面
    {
        fightEndVoice.text = "呜....搞砸了....";
        kroosFace.sprite = gameoverImage;
        transform.GetComponent<EnemyBornControllerCopy>().StopBornEnemy();
        EndFight();
        transform.GetComponent<EnemyBornControllerCopy>().EndFight();
        ...
        ArchiveSystem.Instance.GameEnd(Mathf.FloorToInt(GlobleDamageCounter.Instance.GetDamage() * 0.5f) , Mathf.FloorToInt(GlobleDamageCounter.Instance.GetDamage()));
    ...
    private void EndWaves()              //结束本次波次，如果此次波次掉落奖励为0则最后一个怪物强制掉落一个?清空掉落当前波次数量
    {
        ...
        if (nowWave == 3)
        {
            ...
            transform.GetComponent<EnemyBornControllerCopy>().EndFight();
            // ArchiveSystem.Instance.GameEnd(Mathf.FloorToInt((enemyKillInWaves[0] * 1 + enemyKillInWaves[1] * 1.5f + enemyKillInWaves[2] * 2) * scoreGet * 0.5f) , Mathf.FloorToInt((enemyKillInWaves[0] * 1 + enemyKillInWaves[1] * 1.5f + enemyKillInWaves[2] * 2) * scoreGet));
            ArchiveSystem.Instance.GameEnd(Mathf.FloorToInt(GlobleDamageCounter.Instance.GetDamage() * 0.5f + 500 * 180f/gameTime) , Mathf.FloorToInt(GlobleDamageCounter.Instance.GetDamage() + 1000 * 180f/gameTime));
            GlobleDamageCounter.Instance.ResetDamage();
        }
    }
