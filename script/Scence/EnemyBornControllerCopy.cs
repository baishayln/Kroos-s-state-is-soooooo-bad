...
public class EnemyBornControllerCopy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (relaxTimer > 0 && !isEndFight)
        {
            ...
            {
                nowWave ++ ;
                transform.GetComponent<FightUIControllerCopy>().WaveStart(nowWave);
                // Debug.Log(nowWave);
            }
    ...
    {
        transform.GetComponent<FightUIControllerCopy>().BornEnemy();
